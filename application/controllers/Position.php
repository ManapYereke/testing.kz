...
class Position extends CI_Controller
{
    ...
    {
        $this->db->delete("tb0203_positions", array("tb0203_id" => $tb0203_id));
    ...
    public function controller()
    {
        ...
        if ($this->uri->segment(3)) {
            $data = $this->db->get_where("tb0203_positions", array("tb0203_id" => urldecode($this->uri->segment(3))))->row_array();
