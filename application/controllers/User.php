...
class User extends CI_Controller {
	...
	public function registration()
	{
		...
		$tb0101=[
			...
			,"tb0101_idn"=>$this->input->post("tb0101_idn")
			,"tb0101_passwd"=>md5($this->input->post("tb0101_passwd1",1))
			...
			,"tb0101_email"=>$this->input->post("tb0101_email",1)
			,"tb0101_phone1"=>$this->input->post("tb0101_phone1",1)
			,"tb0101_phone2"=>$this->input->post("tb0101_phone2",1)
			,"tb0101_tb0003_id"=>$this->input->post("tb0101_tb0003_id",1)
		];

		$tb0102=[
			"tb0102_idn"=>$this->input->post("tb0102_idn",1)
			,"tb0102_name_ru"=>$this->input->post("tb0102_name_ru",1)
			,"tb0102_name_kz"=>$this->input->post("tb0102_name_kz",1)
			,"tb0102_phone1"=>$this->input->post("tb0102_phone1",1)
			,"tb0102_phone2"=>$this->input->post("tb0102_phone2",1)
			,"tb0102_email"=>$this->input->post("tb0102_email",1)
			,"tb0102_addr"=>$this->input->post("tb0102_addr",1)
			,"tb0102_tb0101_id"=>@$tb0101["tb0101_id"]
			,"tb0102_createdby"=>@$tb0101["tb0101_id"]
		];
			...
			$res=$this->tablecontroller->processor(
				...
				,[			// $columns
					...
					,"tb0101_tb0003_id"=>[
						"iskey"=>0
						,"type"=>"string"
						,"template"=>"%tb0003_groups.tb0003_name_ru%"
					]
					,"tb0101_name1"=>[
						"iskey"=>0
						,"type"=>"string"
						,"template"=>"%tb0101_name1%"
					]
					,"tb0101_name2"=>[
						"iskey"=>0
						,"type"=>"string"
						,"template"=>"%tb0101_name2%"
					]
				]
				,2			// $cmdSegment
				,null 		// $onSaveSuccess
