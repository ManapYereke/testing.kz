		...
		<div class="content-container">
			<div class="page-header animated slideInDown">
				<h1 class="text-muted discount-card-text">
					<i class="fas fa-list"></i> Виды обучения
				</h1>
			</div>
			...
			ONLOAD.push(function() {
				$('.table').dataTable({
					...
					initComplete: function() {
						$('.dataTables_length').prepend('<a class="btn btn-primary btn-sm" href="<?= site_url($this->uri->segment(1) . "/add") ?>"><i class="far fa-plus-square"></i> Добавить вид обучения</a>&nbsp;&nbsp;&nbsp;');
					}
				}).on('draw.dt', function() {
